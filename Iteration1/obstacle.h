...
public:
	Obstacle();
    Obstacle(int speed, int width, int height, int id, int damage, TypeObstacle type, Vector2* validSpawn[MAX_VALIDSPAWN]); //va etre retirer lorsque les obstacles specifiques
