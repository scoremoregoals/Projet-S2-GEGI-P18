...
Runner::Runner()
{
	...
	_animationLeft = new Animation(1000, 100, 10, "spritesheets/bb8-gauche.png");
	_animationRight = new Animation(1000, 100, 10, "spritesheets/bb8-droite.png");
	_currentAnimation = new Animation(1000, 100, 10, "spritesheets/bb8-droite.png");
